...
# กรอกข้อมูล
${NAME_FIS}    xpath=//android.widget.EditText[@index=4]
...
#คลิกหน้าต่อไป
${NEXT_CL}    xpath=//android.view.ViewGroup[@index=23]
...
# แก้ไขข้อมูลบ่อตกปลา
${ED_EVE}    xpath=(//android.view.ViewGroup)[15]
${ED_CL}    //*[@text="แก้ไขข้อมูลการจัดตกปลา"]
# ERROR เหลือง
${ER_YO}    //android.view.ViewGroup[@index=2]
${AL_CL}    xpath=/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup[2]/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[3]/android.widget.ImageView
#ERROR RED
${ERROR_RED}    //*[@text="DISMISS"]
${EREX1}    (//android.widget.TextView)[1]
# เวลา ชั่วโมง
