...
Resource    ../Resource/RS_TD13_Weight_Fishing_Score_Member.robot
*** Variables ***
${excel_path}    C:/Users/MSI/Desktop/Test_Projact/TestData/TD13_Weight_Fishing_Score_Member.xlsx

*** Test Cases ***
TD13_Weight_Fishing_Score_Member
    Start Video Recording   alias=None  name=C:/Users/MSI/Desktop/Test_Projact/Result/Video/TD13_Weight_Fishing_Score_Member  fps=None    size_percentage=1   embed=True  embed_width=100px   monitor=1
    ...
    Wait Until Page Contains Element    ${POUN}    20s
    Click Element    ${POUN}
    ...
    FOR    ${i}    IN RANGE   2    ${excel.max_row+1}
        ...
        Wait Until Page Contains Element    ${MEMBER}    20s
        Click Element    ${MEMBER}
        Wait Until Page Contains Element    ${Summary}    20s
        Input Text    ${Summary}    ${WEF}
        Wait Until Page Contains Element    ${Submit1}    20s
        ...
        Log To Console    ${is_vis3}
            IF  ${is_vis3} == True
                ...
                Click Element    ${KAKA}
            ELSE
                ${COM1}    Set Variable    เพิ่มน้ำหนักตกปลาผู้เข้าร่วม
    ...
    Save Excel Document       C:/Users/MSI/Desktop/Test_Projact/Result/WriteExcel/TD13_Weight_Fishing_Score_Member_result.xlsx
    Close Application
