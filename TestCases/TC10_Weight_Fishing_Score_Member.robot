...
Resource    ../Resource/RS_TC10_Weight_Fishing_Score_Member.robot
*** Variables ***
${excel_path}    C:/Users/MSI/Desktop/Test_Projact/TestData/TC10_Weight_Fishing_Score_Member.xlsx

*** Test Cases ***
TC10_Weight_Fishing_Score_Member
    Start Video Recording   alias=None  name=C:/Users/MSI/Desktop/Test_Projact/Result/Video/TC10_Weight_Fishing_Score_Member    fps=None    size_percentage=1   embed=True  embed_width=100px   monitor=1
    ...
    Wait Until Element Is Visible    ${DaTA_POMENU}    20s
    Click Element    ${DaTA_POMENU}
    Wait Until Element Is Visible    ${HIS_EVE}    20s
    ...
    FOR    ${i}    IN RANGE   2    ${excel.max_row+1}
        ...
        Wait Until Element Is Visible    ${MEMBER}    20s
        ...
        Log To Console    ${is_vis3}
            IF  ${is_vis3} == True
                ...
                END
                Wait Until Element Is Visible    ${alet_ok}    20s
                Click Element    ${alet_ok}
                # Sleep    2s
                Wait Until Element Is Visible    ${KAKA}    20s
                Click Element    ${KAKA}
            ELSE
                ${COM1}    Set Variable    -
    ...
    Save Excel Document       C:/Users/MSI/Desktop/Test_Projact/Result/WriteExcel/TC10_Weight_Fishing_Score_Member_result.xlsx
    Close Application
