...
Resource    ../Resource/RS_TC04_EditProfile.robot
Library        ../Scripts/SplitMonthAndDate.py
*** Variables ***
${excel_path}    C:/Users/MSI/Desktop/Test_Projact/TestData/TD04_Edit_Profile.xlsx
*** Test Cases ***
TC04_EditProfile

    Start Video Recording   alias=None  name=C:/Users/MSI/Desktop/Test_Projact/Result/Video/TC04_EditProfile  fps=None    size_percentage=1   embed=True  embed_width=100px   monitor=1
    ...
    Click Login page
        ...
        FOR    ${i}    IN RANGE   2    ${excel.max_row+1}
            ...
            IF    "${EXE}" == "Y"
                ...
                Wait Until Page Contains Element    ${CL_PEIN}    15s
                Click Element    ${CL_PEIN}
                
                Swipe    0    800    0    100    1000
                Wait Until Page Contains Element    ${BT_PEIN}
            ...
            END        
        END
        Save Excel Document       C:/Users/MSI/Desktop/Test_Projact/Result/WriteExcel/TC04_EditProfile_result.xlsx
        Sleep    2s
        Close Application
