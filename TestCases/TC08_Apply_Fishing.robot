...
Resource    ../Resource/RS_TC08_Apply_Fishing.robot
*** Variables ***
${excel_path}    C:/Users/MSI/Desktop/Test_Projact/TestData/TC08_Apply_Fishing.xlsx
*** Test Cases ***
TC08_Apply_Fishing
    #-----------------------------------------------ยังแก้ไม่หมด------------------------------------------------------------
    Start Video Recording   alias=None  name=C:/Users/MSI/Desktop/Test_Projact/Result/Video/TC08_Apply_Fishing  fps=None    size_percentage=1   embed=True  embed_width=100px   monitor=1
    #--------------------------------------------------------------------------------------------------------------------
    ...
    FOR    ${i}    IN RANGE   2    ${excel.max_row+1}
        ...
        END
    END
    Save Excel Document       C:/Users/MSI/Desktop/Test_Projact/Result/WriteExcel/TC08_Apply_Fishing_result.xlsx
    Close Application
