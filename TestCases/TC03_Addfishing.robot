...
Resource    ../Resource/RS_TC03_Addfishing.robot
*** Variables ***
${excel_path}    C:/Users/MSI/Desktop/Test_Projact/TestData/TD03_Addfishing.xlsx

*** Test Cases ***
TC03_Addfishing

    # Start Video Recording   alias=None  name=C:/Users/MSI/Desktop/Test_Projact/Result/Video/TD03_Addfishing  fps=None    size_percentage=1   embed=True  embed_width=100px   monitor=1
                    ...
                    IF     ${COMPLES} == True
                        ...
                        # FOR    ${C}    IN RANGE    5
                            ...
                            ELSE
                                ...
                                END
                                Capture Page Screenshot    ${EXECDIR}/Result/Screenshot/${testcaseData}.png
                                Write Excel Cell    ${i}    11    value=${RESULT3}    sheet_name=TestData
                                Write Excel Cell    ${i}    12    value=FAIL    sheet_name=TestData
                                Write Excel Cell    ${i}    13    value=Error    sheet_name=TestData
                                Write Excel Cell    ${i}    14    value=ควรแจ้งให้ผู้ใช้งานว่า : ${EXP}    sheet_name=TestData
                            END
    ...
    Save Excel Document       C:/Users/MSI/Desktop/Test_Projact/Result/WriteExcel/TC03_Addfishing_result.xlsx
    Close Application
    Sleep    2s
